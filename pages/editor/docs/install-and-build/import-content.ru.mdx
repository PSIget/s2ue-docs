---
description: "Импорт контента из gamedata/rawdata в STALKER on UE: подготовка ресурсов, настройка директорий, минимальный импорт для PIE."
---
...
* В папку gamedata необходимо переместить всё остальное
...
По очерёдности вызовете все команды импорта:
