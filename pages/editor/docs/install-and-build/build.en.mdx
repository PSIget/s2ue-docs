---
description: "Guide on building STALKER on UE source code: preparation, automatic and manual project assembly, editor launch."
---
...
```bash
git clone https://github.com/RedPandaProjects/STALKERonUE --recursive
```
